...
urlpatterns = [
    ...
    path('timespent/', time_spent_list, name='timespent'),#Список отчетов
    path('deletes_project/<int:project_id>/', deletes_project, name='deletes_project'),
    path('projects/', projects, name='projects'),#Проекты
    ...
    path('archived_projects/', archive, name='archived_projects'),#Архив проектов
